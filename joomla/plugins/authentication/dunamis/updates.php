...
/**
 * JBlesta Authentication Plugin Update Manager
 * @desc		This file is called up through Dunamis for checking on updates for the plugin
 * @package		J!Blesta
 * @subpackage	Joomla
 * @author		@packageAuth@
 * @link		@packageLink@
 ...
 * @license		@packageLice@
 */
class Jblesta_authDunUpdates extends JoomlaDunUpdates
{
	...
	protected $_url			=	'https://www.gohigheris.com/updates/jblesta/plugin-authentication';
	 ...
	 * @access		public
	 * @version		@fileVers@
	 * @param		array		Any options we want to set
	 *
	 * @since		1.0.0
	 */
	 ...
	 * @access		public
	 * @version		@fileVers@
	 * @param		array		Contains an array of arguments we want to set
	 *
	 * @return		object
	 * @since		1.0.0
	 */
	...
	protected function _updateWrite()
	{
		...
		$db->setQuery( "UPDATE `mod_jwhmcs_settings` SET `value` = " . $db->Quote( $data, false ) . " WHERE `key` = 'updates'" );
